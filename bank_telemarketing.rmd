...
## 3.2 Tradeof between accuracy and sensitibity

To be honest, the results of the ensemble model don't seem quite impressive. Do them? 

But we can still do something. Remember that our objective is to optimize the resources of our marketing department. For example, imagine that the department has a budget to do 1000 calls. 
